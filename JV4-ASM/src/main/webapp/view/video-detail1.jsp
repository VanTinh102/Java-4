			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="description ms-3"
						...
						<p>PHIM HÀI THVL - Nơi tập hợp những tiểu phẩm hài, phim hài,
							chương trình hài kịch hay nhất, mới nhất 2022 đã và đang được
							phát sóng trên Truyền hình Vĩnh Long. Không chỉ được thưởng thức
							các vở kịch, phim hài đủ các thể loại qua phần trình diễn của các
							diễn viên hài nổi tiếng hiện nay như: Hoài Linh, Việt Hương, Trấn
							Thành, Trường Giang, Lê Dương Bảo Lâm,cố NS Chí Tài, Tuấn dũng,
							Thu Trang, Tiến Luật Đến với PHIM HÀI THVL khán giả còn có cơ hội
							được cười bể bụng với các cây hài "mới nhú", các tiết mục độc đáo
							có một không hai.</p>
					</div>
				</div>
